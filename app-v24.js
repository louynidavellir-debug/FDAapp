...
(function() {
    ...
    refreshGames = function() {
        ...
        const appendGameSectionV12 = (items, historyMode=false) => {
            ...
            section.className='games-section-block' + (historyMode ? ' history' : '');
            const h=document.createElement('div');
            h.className='games-section-title' + (historyMode ? ' history' : '');
            h.innerHTML=historyMode
                ? '<span>ᛏ</span><div><strong>Operações anteriores</strong><small>Histórico concluído da equipe.</small></div>'
