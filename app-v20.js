...
(function() {
    ...
    function getAchievementProgressV19(achievement, user) {
        ...
        if (metric === 'validated_games') {
            ...
            return { current:safe, target, percent:Math.min(100, Math.round((safe/target)*100)) };
        }
        const games = getStore(DB_GAMES) || [];
