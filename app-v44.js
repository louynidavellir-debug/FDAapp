...
(function() {
    ...
    window.addEventListener('online',()=>{ clearTimeout(cloudReconnectTimerV43); cloudHasRecentErrorV2=false; updateConnectionUiV2(); showToast('Conexão restabelecida. Sincronizando...', 'success'); });
